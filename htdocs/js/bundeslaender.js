$(function() {
  ...
  $.getJSON("/gis/bundeslaender", function (jsonResponseBody) {
    if(jsonResponseBody) {
      console.log("JSON WS /gis/bundeslaender successful: " + jsonResponseBody.ok);
      if(jsonResponseBody.ok) {
      h = "<table>"
      h += "<tr><th>#</th><th>Bundesland</th><th>Einwohner</th><th>Falschparker-Meldungen</th><th>pro 100.000</th></tr>"
