$(function() {
  ...
  $.getJSON("/gis/mittlere_gemeinden", function (jsonResponseBody) {
    if(jsonResponseBody) {
      console.log("JSON WS /gis/mittlere_gemeinden successful: " + jsonResponseBody.ok);
      if(jsonResponseBody.ok) {
        h = "<table>"
        h += "<tr><th>#</th><th>Stadt/Gemeinde</th><th>Einwohner</th><th>Falschparker-Meldungen</th><th>pro 100.000</th></tr>"
